        ...
        <div className="absolute top-6 right-6">
          {!open ? (
            <button
              ...
              className="bg-white border border-gray-300 px-4 py-2 rounded-xl shadow-md hover:shadow-lg transition hover:scale-105 text-gray-800 flex items-center justify-between w-full"
            >
              <span>Ask Codex</span>
